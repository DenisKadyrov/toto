    ...
    try {
        ...
        const updatedTask = await prisma.task.update({
            ...
            data: {
                ...
                status: body.status ? Status[body.status.toUpperCase()] : existingTask.status,
                priority: body.priority ? Priority[body.priority.toUpperCase()] : existingTask.priority,
                dueDate: body.dueDate ? new Date(body.dueDate) : existingTask.dueDate,
                responsibleId: body.assignee ?? existingTask.responsibleId,
            },
        });
